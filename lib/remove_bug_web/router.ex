defmodule RemoveBugWeb.Router do
  use RemoveBugWeb, :router
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: RemoveBugWeb.Telemetry
    end
  end
